...
#seen in the SI of the manuscript for the low to high deletion sequence
...
#weighted connectance and relative ascendency for the webs in the script "Main_results_for_reviewers.R"
m<-matrix(NA,1000,34)

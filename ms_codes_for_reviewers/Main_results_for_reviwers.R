...
####READ ME####
#This script contains code to replicate the main results in the manuscript "Food web robustness depends on network type and threshold for extinction".
...
colnames(df.allTH)<-c("Links/no links","90%","80%", "70%", "60%",
                      "50%","40%", "30%", "20%", "10%", "Year", "webs")
for (i in 1:10){
  df.allTH[,i]<-apply(wR50list[[i]],1, median)
}
as.data.frame(df.allTH)

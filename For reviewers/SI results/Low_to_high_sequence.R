...
#plots
ggplot(uw.DF.low_high.plots, aes(x=con, y=R50, colour=year))+
  geom_point()+
...
ggplot(uw.DF.low_high.plots, aes(x=`A/C`, y=R50, colour=year))+
  geom_point()+
  stat_smooth(method = "glm",
              formula = "y~x",
              geom = "smooth",
...
# plots
ggplot(w.DF.low_high.plots, aes(x=w.con, y=R50, colour=year))+
  geom_point()+
  stat_smooth(method = "glm",
              formula = "y~x",
              geom = "smooth",
...
ggplot(w.DF.low_high.plots, aes(x=`A/C`, y=R50, colour=year))+
  geom_point()+
  stat_smooth(method = "glm",
              formula = "y~x",
              geom = "smooth",

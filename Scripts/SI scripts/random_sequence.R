...
#seen in the SI of the article for the random deletion sequence.
...
d.comb.rand
d.comb.rand$name<-factor(d.comb.rand$name, levels = c("No Threshold","90%","80%", "70%", "60%",
                                                      "50%","40%", "30%", "20%", "10%"))
...
png(filename = "SIFigure 4.png", width = 16, height = 8.5, units = "in", res=600)
si.fig4
dev.off()
...
si7<-si.fig7a+theme(legend.position = "none")+labs(tag = "(a)")+theme(plot.tag = element_text(size = 22,face = "bold"))+
si.fig7b+theme(axis.title.y=element_blank())+theme(axis.text.y=element_blank())+theme(legend.position = "none")+labs(tag = "(b)")+theme(plot.tag = element_text(size = 22,face = "bold"))

png(filename = "SIFigure 7.png", width = 16, height = 8.5, units = "in", res=600)
si7
dev.off()
...
si8<-si.fig8a+theme(legend.position = "none")+labs(tag = "(a)")+theme(plot.tag = element_text(size = 22,face = "bold"))+
  si.fig8b+theme(axis.title.y=element_blank())+theme(axis.text.y=element_blank())+theme(legend.position = "none")+labs(tag = "(b)")+theme(plot.tag = element_text(size = 22,face = "bold"))

png(filename = "SIFigure 8.png", width = 16, height = 8.5, units = "in", res=600)
si8
dev.off()
